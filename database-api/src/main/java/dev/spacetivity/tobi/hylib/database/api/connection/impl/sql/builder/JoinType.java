 ...
 *
 * @see Join
 * @see SelectBuilder#innerJoin(dev.spacetivity.tobi.hylib.database.api.connection.impl.sql.Table, dev.spacetivity.tobi.hylib.database.api.connection.impl.sql.Column, dev.spacetivity.tobi.hylib.database.api.connection.impl.sql.Column)
 * @since 1.0
 */
